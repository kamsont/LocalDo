...
public class TestData {
	...
	public TestData() {
		...
		toDos.add(new ToDo(0, "Return book", 1400503759000l, 0, locationAsParam, true, MyConstants.RED)); 
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(3));
		toDos.add(new ToDo(1, "Pay college tuitions", 1400162400000l, 0, locationAsParam, true, MyConstants.YELLOW));
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(2));
		toDos.add(new ToDo(2, "Buy gift", -1, -1, locationAsParam, false, MyConstants.GREEN));
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(4));
		toDos.add(new ToDo(3, "Try new Coffee", 1400162400000l, 0, locationAsParam, false, MyConstants.NO_COLOR));
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(0));
		locationAsParam.add(locations.get(1));
		locationAsParam.add(locations.get(4));
		toDos.add(new ToDo(4, "Meet group member",1400857200000l, 0, locationAsParam, true, MyConstants.RED));
//		locationAsParam = new ArrayList<MyLocation>();
//		locationAsParam.add(locations.get(4));
//		toDos.add(new ToDo(4, "Meet group member",locationAsParam, true, ToDoColor.RED));
//		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(0));
		toDos.add(new ToDo(5, "Get book", -1, -1, locationAsParam, false, MyConstants.BLUE));
		locationAsParam = new ArrayList<MyLocation>();		
		toDos.add(new ToDo(6, "Meet Assistant", -1, -1, locationAsParam, true, MyConstants.RED));
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(3));
		toDos.add(new ToDo(6, "Meet Assistant", -1, -1, locationAsParam, true, MyConstants.RED));
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(2));
		toDos.add(new ToDo(7, "Get milk", -1, -1, locationAsParam, true, MyConstants.YELLOW)); 
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(0));
		locationAsParam.add(locations.get(1));
		locationAsParam.add(locations.get(2));
		locationAsParam.add(locations.get(3));
		locationAsParam.add(locations.get(4)); 
		toDos.add(new ToDo(8, "Learn for exams!", -1, -1, locationAsParam, true, MyConstants.RED));
//		locationAsParam = new ArrayList<MyLocation>();
//		locationAsParam.add(locations.get(1));
//		toDos.add(new ToDo(8, "Learn for exams!", locationAsParam, true, ToDoColor.RED));
		locationAsParam = new ArrayList<MyLocation>();
		locationAsParam.add(locations.get(3));
		toDos.add(new ToDo(9, "Get new ECUM", -1, -1, locationAsParam, false, MyConstants.GREEN));
	}	
